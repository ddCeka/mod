...
init 2 python in mod:
    ...
    class PathDetectionClass(NonPicklable):
        lookAheadLimit = 20
        ...
        def code(self):
            if self._m1_PathDetection__code == None:
                try:
                    ...
                    print(': PathDetection: Failed to generate path code. {}'.format(e))
            ...
            class SetNode():
                ...
                def __call__(self):
                    try:
                        ...
                        print(': Failed to force path choice: {}'.format(e))
            ...
            class OpenCodeViewAction():
                ...
                def __call__(self):
                    renpy.show_screen(
                        'mod_CodeView',
                        code=self.path.code,
                        title='{mod_notl}Path code{/mod_notl}',
